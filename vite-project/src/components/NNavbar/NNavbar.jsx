...
const Navbar = ({ setSL, scrollToSection, menuRef, mobileAppRef }) => {
    ...
    const handleMenuClick = (menuItem, targetRef) => {
        if (menuItem === "cart") {
            navigate("/cart");
        } else {
            setMenu(menuItem);
    ...
    return (
        <div className='navbar'>
            ...
            <ul className='navbar-menu'>
                ...
                <li onClick={() => handleMenuClick("menu", menuRef)} className={menu === "menu" ? "active" : ""}>menu</li>
                <li onClick={() => handleMenuClick("mobile-app", mobileAppRef)} className={menu === "mobile-app" ? "active" : ""}>mobile-app</li>
